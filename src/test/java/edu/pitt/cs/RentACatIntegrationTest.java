...
public class RentACatIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		// TODO: Fill in
		c3 = Cat.createInstance(InstanceType.IMPL, 2, "Mistoffelees");
	...
	public void testGetCatNullNumCats0() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		assertEquals(null , method.invoke(r,2));	
	...
	public void testGetCatNumCats3() throws Exception {
		...
		Method method = r.getClass().getDeclaredMethod("getCat", int.class);
		method.setAccessible(true);
		Cat getcat = (Cat) method.invoke(r,2);	
		assertNotEquals(null, getcat);
		int id = getcat.getId();
		assertEquals(2, id);
	}
	...
	public void testListCatsNumCats3() {
		String threecat = r.listCats();
		assertEquals("", threecat);
	}
